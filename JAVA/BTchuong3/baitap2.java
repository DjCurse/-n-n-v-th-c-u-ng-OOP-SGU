...
public class baitap2 {
    public static void main(String[] args) { 
        ...
        System.out.println("Truoc khi boxing: "); 
        h.xuat(); 
        System.out.println("sau khi boxing: "); 
        h = s2; // boxing
        h.xuat();  
        System.out.println();
        System.out.println("truoc khi unboxing: "); 
        s1.xuat();
        System.out.println("sau khi unboxing: ");
        s1 = (Student)h; // unboxing
        s1.xuat();
